...
import com.brainhealth.databinding.ActivityLoginBinding
import com.brainhealth.register.RegisterActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun observe() {
        ...
        viewModel.loginResponse.observe(this) {
            if (it != null) {
                val intent = Intent(this@LoginActivity, com.brainhealth.MainActivity::class.java)
                startActivity(intent)
                finish()
            }
        }
